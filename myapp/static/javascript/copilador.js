document.addEventListener("DOMContentLoaded", function () {
    ...
    enviarCodigoBtn.addEventListener('click', function () {
        ...
        const mensajeChatGPT = 
            `CORRIJA ESTE EJERCICIO , LAS CORRECIONES LAS DEBE HACER EN VIÑETAS SI ES EL CASO , NO DECIR AQUI TIENES LAS CORRECIONES PARA EL EJERCICIO PROPUESTO NI NADA PARECIDO , SOLO MUESTRE EL MENSAJE CON CORRECIONES Y YA , NO MUESTRE EL CODIGO YA CORREGIDO , DE CORRECIONES ESPECIFICAS Y POSIBLES EJEMPLOS QUE PUEDEN SERVIR PARA SOLUCIONAR DICHO ERROR, EN CASO DE QUE LO QUE ESCRIBIO EL USUARIO ESTE BIEN ANALICE QUE LE FALTA PARA COMPLETAR CON LA DESCRIPCIÓN DEL EJERCICIO PROPUESTO SI ES EL CASO ` +
            `EL EJERCICIO QUE SE DEBE HACER ES ESTE: "${descripcionEjercicio}". ` +
            `Y LO QUE EL USUARIO ENVIO ES ESTO: "${codigoUsuario}".`;
